...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'selenium_tests_profile', (
            ...
            ('DateSubmitted', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 25, 0, 0), null=True, blank=True)),
            ('Approved', self.gf('django.db.models.fields.IntegerField')(default=-1)),
        ))
        db.send_create_signal(u'selenium_tests', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table(u'selenium_tests_profile')
    ...
    models = {
        ...
        u'selenium_tests.profile': {
            ...
            'DateSubmitted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
