...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PpfaTestStep'
        db.create_table(u'selenium_tests_ppfateststep', (
            ...
            ('ppfa_test', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ppfa_test_step_test', to=orm['selenium_tests.PpfaTest'])),
        ))
        db.send_create_signal(u'selenium_tests', ['PpfaTestStep'])


    def backwards(self, orm):
        # Deleting model 'PpfaTestStep'
        db.delete_table(u'selenium_tests_ppfateststep')
    ...
    models = {
        ...
        u'selenium_tests.ppfateststep': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ppfa_test': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ppfa_test_step_test'", 'to': u"orm['selenium_tests.PpfaTest']"}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'verb': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'selenium_tests.profile': {
            'Approved': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'DateSubmitted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
